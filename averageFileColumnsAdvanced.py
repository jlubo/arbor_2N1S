...
def averageFileColumns(outname, rootpath, protocol, req_contains, req_suffix, columns, \
                       columns_sum = [], par_first_column=True, skip_first_line=False, col_sep = '\t\t'):
...
suffix = '_traces.txt'
averageFileColumns('averaged_STET', '.', 'data_STET', [], suffix, [2, 3, 4, 5], [2, 3], skip_first_line=False, col_sep=' ')
averageFileColumns('averaged_WTET', '.', 'data_WTET', [], suffix, [2, 3, 4, 5], [2, 3], skip_first_line=False, col_sep=' ')
averageFileColumns('averaged_SLFS', '.', 'data_SLFS', [], suffix, [2, 3, 4, 5], [2, 3], skip_first_line=False, col_sep=' ')
averageFileColumns('averaged_WLFS', '.', 'data_WLFS', [], suffix, [2, 3, 4, 5], [2, 3], skip_first_line=False, col_sep=' ')
''' 
...
suffix = '_data.txt'
averageFileColumns('averaged_STET', '.', 'STET', [], suffix, [8, 9, 10], skip_first_line=True)
averageFileColumns('averaged_WTET', '.', 'WTET', [], suffix, [8, 9, 10], skip_first_line=True)
averageFileColumns('averaged_SLFS', '.', 'SLFS', [], suffix, [8, 9, 10], skip_first_line=True)
averageFileColumns('averaged_WLFS', '.', 'WLFS', [], suffix, [8, 9, 10], skip_first_line=True)
